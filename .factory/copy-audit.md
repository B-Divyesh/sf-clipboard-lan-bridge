...
| The receiving device must approve before a route exists. | 9 |
| Choose what leaves | 3 |
| Paste or type one text item, pick a device, then press Send. | 12 |
| The clipboard is never monitored. | 5 |
| Copy before expiry | 3 |
| The encrypted ticket arrives over your LAN. | 7 |
| Copy it before its expiry time. | 6 |
